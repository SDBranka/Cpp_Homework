/*
  ...
  * Lab: 7
  * Due Date: 3-10-2016
  * Description: This program outputs a user designated number of numbers to a file, then reads
  *              the numbers from the file back into the program, displays them, and then displays  
  *              the largest, smallest, and total average of the numbers
  */
...
void iStream(int &, int &, double &); //handles the input from proj7.txt and displays numbers
...
int main()
{
    ...
    do
    {
        ...
        iStream(largest, smallest, average);   //handles the input from proj7.txt and displays numbers
        showStats(largest, smallest, average); //displays stats
...
void iStream(int &biggest, int &tiniest, double &ave) //handles the input from proj7.txt and displays numbers
{
    int aveCount = 0,
        number;
    double numberSum = 0;
...
void showStats(int big, int small, double average) //displays stats
{
    cout.setf(ios::fixed);
